...
def MRI_Eigenproblem(shear, target_m, nth,nr,Re,M,neig,guess,comm,label=None):
    ...
    # Set up output dir
    data_dir = 'MRI_Model_Fit_M{:.2f}_ellmax{:d}_m{:d}'.format(np.log10(Mag), Lmax, target_m)+'_'+label
